...
workspace_name = "coursework-beta" # PLACEHOLDER
subscription_id = "477eb351-e805-423a-a00e-ed37cfffa1f1" # PLACEHOLDER
resource_group = "coursework-beta" # PLACEHOLDER
experiment_name = "regression" # PLACEHOLDER
iteration = "22"  # PLACEHOLDER
run_id = "AutoML_0baf8f33-97bf-4b40-b494-dfafcad5190a_22"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'enable_early_stopping':True,'enable_ensembling':True,'enable_stack_ensembling':True,'ensemble_iterations':15,'enable_onnx_compatible_models':False,'save_mlflow':True,'max_cores_per_iteration':-1,'send_telemetry':True,'blacklist_algos':['TensorFlowDNN','TensorFlowLinearRegressor'],'whitelist_models':None,'compute_target':'cheap','enable_dnn':False,'enable_code_generation':True,'experiment_exit_score':None,'experiment_timeout_minutes':90,'featurization':'auto','hyperdrive_config':None,'grain_column_names':None,'is_timeseries':False,'iteration_timeout_minutes':90,'max_concurrent_iterations':1,'metric_operation':'minimize','model_explainability':True,'n_cross_validations':None,'name':'regression','path':'./sample_projects/regression','primary_metric':'normalized_root_mean_squared_error','region':'eastus2','resource_group':'coursework-beta','subscription_id':'477eb351-e805-423a-a00e-ed37cfffa1f1','task_type':'regression','validation_size':None,'test_size':None,'vm_type':'STANDARD_A1_V2','workspace_name':'coursework-beta','label_column_name':'multiScore','enable_batch_run':True,'dataset_id':'e4e4f28d-32b5-4472-a2e8-a371aa73a933'} # PLACEHOLDER
pipeline_spec = "{\"objects\": [{\"class_name\": \"StandardScaler\", \"module\": \"sklearn.preprocessing\", \"param_args\": [], \"param_kwargs\": {\"with_mean\": false, \"with_std\": true}, \"prepared_kwargs\": {}, \"spec_class\": \"preproc\"}, {\"class_name\": \"LightGBMRegressor\", \"module\": \"automl.client.core.common.model_wrappers\", \"param_args\": [], \"param_kwargs\": {\"boosting_type\": \"gbdt\", \"colsample_bytree\": 0.6, \"learning_rate\": 0.16842263157894738, \"max_bin\": 1023, \"max_depth\": 9, \"min_data_in_leaf\": 0.0032263930780845784, \"min_split_gain\": 0.7368421052631579, \"n_estimators\": 100, \"num_leaves\": 255, \"reg_alpha\": 0, \"reg_lambda\": 0.75, \"subsample\": 0.9, \"subsample_freq\": 6}, \"prepared_kwargs\": {}, \"spec_class\": \"sklearn\"}], \"pipeline_id\": \"f4c6193ba50075f70966c674e6c689fd23f52ec3\", \"module\": \"sklearn.pipeline\", \"class_name\": \"Pipeline\", \"pipeline_name\": \"{ StandardScaler, LightGBMRegressor }\"}" # PLACEHOLDER
pipeline_id = "f4c6193ba50075f70966c674e6c689fd23f52ec3" # PLACEHOLDER
dataprep_json = "{\"datasets\":0,\"training_data\":{\"datasetId\":\"e4e4f28d-32b5-4472-a2e8-a371aa73a933\"}}" # PLACEHOLDER
